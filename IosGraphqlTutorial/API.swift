...
public final class BookTripsMutation: GraphQLMutation {
  ...
  public var launchIds: [GraphQLID]

  public init(launchIds: [GraphQLID]) {
    self.launchIds = launchIds
  }

  public var variables: GraphQLMap? {
    return ["launchIds": launchIds]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("bookTrips", arguments: ["launchIds": GraphQLVariable("launchIds")], type: .nonNull(.object(BookTrip.selections))),
      ]
    }
...
public final class CancleTripMutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "CancleTrip"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("cancelTrip", arguments: ["launchId": GraphQLVariable("launchId")], type: .nonNull(.object(CancelTrip.selections))),
      ]
    }
    ...
    public struct CancelTrip: GraphQLSelectionSet {
      ...
      public init(success: Bool) {
        self.init(unsafeResultMap: ["__typename": "TripUpdateResponse", "success": success])
      }
